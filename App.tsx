...
const INSTAGRAM_USER = 'goldentouch_joyeria'; // Reemplaza con tu usuario real
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-gold-500 selection:text-black flex flex-col">
      {/* Top Utility Bar con Redes Sociales */}
        ...
        <div className="flex items-center gap-4">
          {isAdmin ? (
            <div className="flex items-center gap-3">
              <span className="text-[9px] text-gold-400 font-bold uppercase tracking-[0.2em]">ADMIN PANEL</span>
      ...
      <nav className="sticky top-0 z-40 bg-black/90 backdrop-blur-xl border-b border-zinc-900 px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-4 items-center">
            <a 
              href="#contactanos" 
              className="text-[10px] text-zinc-400 uppercase font-bold tracking-widest hover:text-gold-500 transition-colors hidden sm:block"
            >
              Contáctanos
            </a>
            {isAdmin && (
      ...
      <main className="flex-grow max-w-7xl mx-auto px-6 py-12">
        {isLoading ? (
          ...
          <div className="text-center py-32">
            <h3 className="text-zinc-500 uppercase tracking-widest text-sm">No se encontraron piezas</h3>
          </div>
        )}
      </main>

      {/* Footer / Contáctanos */}
      <footer id="contactanos" className="bg-zinc-950 border-t border-zinc-900 pt-16 pb-8 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <p className="text-zinc-500 text-sm leading-relaxed max-w-xs">
              Exclusividad y arte en joyería fina de 18k. Cada pieza es diseñada para perdurar y brillar con luz propia.
            </p>
          </div>
          
          <div className="space-y-6">
            <h3 className="text-xs font-bold uppercase tracking-[0.3em] text-white">Contáctanos</h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div className="text-zinc-400 text-sm">
                  <span className="block text-white font-medium">WhatsApp Directo</span>
              ...
              <li className="flex items-start gap-3">
                ...
                <div className="text-zinc-400 text-sm">
                  <span className="block text-white font-medium">Ubicación</span>
          ...
          <div className="space-y-6">
            <h3 className="text-xs font-bold uppercase tracking-[0.3em] text-white">Síguenos</h3>
            ...
            <p className="text-[10px] text-zinc-600 font-bold uppercase tracking-widest pt-4">© 2026 Golden Touch Jewelry</p>
          </div>
        </div>
      </footer>
      ...
      {showLoginModal && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/95 backdrop-blur-md">
          <div className="luxury-card w-full max-w-md p-10 rounded-3xl border-gold-500/50">
            <h2 className="text-center gold-text text-xs font-bold uppercase tracking-[0.4em] mb-8">Autenticación</h2>
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              />
              <div className="flex gap-4">
                <button type="button" onClick={() => setShowLoginModal(false)} className="flex-1 text-zinc-500 text-[10px] font-bold uppercase tracking-widest py-4">Cancelar</button>
